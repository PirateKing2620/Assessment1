...
const design = 'the process by which an agent creates a specification of a software artifact intended to accomplish goals, using a set of primitive components and subject to constraints.'
const implementation = 'the process of adopting and integrating a software application into a business workflow.'
const testingAndIntegration = 'type of software testing in which the different units, modules or components of a software application are tested as a combined entity.'
const maintain = 'the modification of a software product after delivery to correct faults, to improve performance or other attributes.'
